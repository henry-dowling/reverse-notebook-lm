#!/usr/bin/env python3
"""
Final corrected script to automatically load all FastAPI tools into ElevenLabs.
Based on exact API documentation requirements.
"""
...
def get_tool_configs():
    """Define all tool configurations with correct API schema structure"""
    tools = [
        # Simple GET tools
        {
            "tool_config": {
        ...
        # Tools with path parameters only
        {
            "tool_config": {
                "type": "webhook",
        ...
        # Tools with both path parameters and request body
        {
            "tool_config": {
                "type": "webhook",
...
def main():
    ...
    print("🚀 Loading all 13 tools into ElevenLabs (Final Version)...")

#!/usr/bin/env python3
"""
Script to automatically load all FastAPI tools into ElevenLabs.
This script creates all 13 tools in your ElevenLabs workspace using the ElevenLabs API.
"""
...
def get_tool_configs():
    """Define all tool configurations for ElevenLabs"""
    tools = [
        {
            "tool_config": {
                "type": "webhook",
                ...
                "webhook": {
                    ...
                    "api_schema": {
                        ...
                        "properties": {
                            "filename": {
                                "type": "string",
                                "description": "Name of the script file including extension"
                            }
                        },
                        "required": ["filename"]
                    }
...
def main():
    ...
    print("🚀 Loading tools into ElevenLabs...")
